...
cst_container_instances._metadata = CloudServiceTypeMeta.set_meta(
    ...
    search=[
        ...
        SearchField.set(name='Memory size(GB)', key='data.memory_size_display', data_type='float'),
        SearchField.set(name='GPU count', key='data.gpu_count_display', data_type='integer'),
        SearchField.set(name='Volume count', key='data.volume_count_display', data_type='integer'),
